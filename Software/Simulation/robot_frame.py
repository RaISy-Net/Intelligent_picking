...
def MakeRobot(x,y,z=0.5,scale_x=1,scale_y=1,scale_z=0.5,Inter_area_dist=1,pickAreaHeight=0.9):
	...
	base2 = p.createMultiBody(baseCollisionShapeIndex=base_c,baseVisualShapeIndex=base_v,basePosition=[-scale_x - 0.1,y ,z+scale_z+0.075])
	...
	pole1 = p.createMultiBody(baseCollisionShapeIndex=pole_c,baseVisualShapeIndex=pole_v,basePosition=[scale_x + 0.1,y ,z+scale_z+0.15+(0.6+pickAreaHeight)/2])
	pole2 = p.createMultiBody(baseCollisionShapeIndex=pole_c,baseVisualShapeIndex=pole_v,basePosition=[-scale_x - 0.1,y ,z+scale_z+0.15+(0.6+pickAreaHeight)/2])
	...
	upper_base1 = p.createMultiBody(baseCollisionShapeIndex=upper_base_c,baseVisualShapeIndex=upper_base_v,basePosition=[scale_x + 0.1,y ,z+scale_z+0.15+0.6+pickAreaHeight+0.02])
	upper_base2 = p.createMultiBody(baseCollisionShapeIndex=upper_base_c,baseVisualShapeIndex=upper_base_v,basePosition=[-scale_x - 0.1,y ,z+scale_z+0.15+0.6+pickAreaHeight+0.02])
	...
	h_pole1 = p.createMultiBody(baseCollisionShapeIndex=h_pole_c,baseVisualShapeIndex=h_pole_v,basePosition=[x,y + 0.03 ,z+scale_z+0.15+0.6+pickAreaHeight+0.02], baseOrientation = p.getQuaternionFromEuler([0, 1.570796,0]))
	h_pole2 = p.createMultiBody(baseCollisionShapeIndex=h_pole_c,baseVisualShapeIndex=h_pole_v,basePosition=[x,y - 0.03 ,z+scale_z+0.15+0.6+pickAreaHeight+0.02], baseOrientation = p.getQuaternionFromEuler([0, 1.570796,0]))
	...
	p.createConstraint(upper_base1, -1, h_pole1, -1, p.JOINT_FIXED, [1,0,0], [-scale_x/40, 0.03, 0], [(scale_x + 0.1)-(scale_x/40),0,0])
