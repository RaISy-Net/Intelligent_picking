...
def object_detection():
    ...
    x = centroids[0][0]
    y = centroids[0][1]
    y = y-0.0688+((gs[0].center)[0])*0.00026875 - 0.02
...
def get_grasp_prediction(x,y,a):
    ...
    rgb_path = "C:/Users/yashs/OneDrive/Desktop/PS simulation/rgbd_images/color"+str(a)+".jpeg"
    depth_path = "C:/Users/yashs/OneDrive/Desktop/PS simulation/rgbd_images/depth"+str(a)+".jpeg"
